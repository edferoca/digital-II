...
static inline unsigned int display_sel_read(void) {
	unsigned int r = csr_readl(0xe0005000);
	return r;
}
static inline void display_sel_write(unsigned int value) {
	csr_writel(value, 0xe0005000);
}
#define CSR_DISPLAY_VALUE_ADDR 0xe0005004
#define CSR_DISPLAY_VALUE_SIZE 1
static inline unsigned int display_value_read(void) {
	unsigned int r = csr_readl(0xe0005004);
	return r;
}
static inline void display_value_write(unsigned int value) {
	csr_writel(value, 0xe0005004);
}
#define CSR_DISPLAY_WRITE_ADDR 0xe0005008
#define CSR_DISPLAY_WRITE_SIZE 1
static inline unsigned int display_write_read(void) {
	unsigned int r = csr_readl(0xe0005008);
	return r;
}
static inline void display_write_write(unsigned int value) {
	csr_writel(value, 0xe0005008);
}

/* leds */
#define CSR_LEDS_BASE 0xe0004000
#define CSR_LEDS_OUT_ADDR 0xe0004000
